...
// Maps old App\Services\Ontology\Parsers\ShaclParser to the new
// Youri\vandenBogert\Software\ParserShacl\ShaclParser class.
...
spl_autoload_register(function (string $class): void {
    ...
    $aliases = [
        'App\Services\Ontology\Parsers\ShaclParser' => \Youri\vandenBogert\Software\ParserShacl\ShaclParser::class,
    ];
